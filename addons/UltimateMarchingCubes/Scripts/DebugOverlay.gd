extends Node
const TEMP_LABEL = preload("res://addons/UltimateMarchingCubes/Scenes/TempLabel.tscn")
...
func temp_prop(value, label_name: String = ""):
	var i = TEMP_LABEL.instantiate()
	container.add_child(i)
	i.text = label_name + str(value)
